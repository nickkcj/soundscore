/**
 * Handles the delete review modal, confirmation, and AJAX request.
 * Removes the review card from the DOM on success.
 */
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Confirm delete sends AJAX request and removes review card
    ...
    /**
     * Hide the delete modal with animation and reset button state.
     */
